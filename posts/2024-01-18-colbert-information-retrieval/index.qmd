...
Shout out to the author of the [RAGatouille](https://github.com/bclavie/RAGatouille) library who also wrote a fantastic post making the case for these late interaction retrievers like ColBERT: https://ben.clavie.eu/ragatouille/. He has a [section](https://ben.clavie.eu/ragatouille/#longer-might-read) comparing the pros and cons of:
...
- I've used ColBERT through the [RAGatouille](https://github.com/bclavie/RAGatouille) which makes it really easy to get started and converted it to a langchain retriever using this [tutorial](https://python.langchain.com/docs/integrations/retrievers/ragatouille).