...
I am a Principal level data scientist and ML/AI engineer who codes daily and ships reliable systems. I enjoy deriving business value out of data, training ML models and building AI systems using common protocols like [MCP](https://github.com/jlowin/fastmcp), [LiteLLM](https://github.com/BerriAI/litellm) and agent frameworks like [LangGraph](https://github.com/langchain-ai/langgraph) along with robust evals (that run in CI/CD like GitHub Actions). [Claude Code](https://lawwu.github.io/posts/2025-07-18-starting-to-use-claude-code/) is my agentic coding agent of choice. I’m a curious learner who is fascinated with AI and its impact on work and society at large.
